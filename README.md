...
- `https://namada.rpc.liveraven.net` (LiveRaveN)
...
- `https://namada.indexer.liveraven.net` (LiveRaveN)

## Snapshot service

- `https://bwarelabs.com/snapshots/namada` (BwareLabs)
- `https://services.liveraven.net/cosmos-testnets/namada/snapshot` (LiveRaveN)
